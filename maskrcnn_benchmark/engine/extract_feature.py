        ...
        for batch in tqdm(data_loader):
            ...
            for img_id, t_result, result in zip(image_ids, targets, output):
                writer.writerow({
                    ...
                    "labels": base64.b64encode(result.get_field("labels").numpy()).decode('utf-8'),
                    "attrs": base64.b64encode(result.get_field("attrs").numpy()).decode('utf-8'),
                    "bbox": base64.b64encode(result.bbox.numpy()).decode('utf-8'),
                    "feature": base64.b64encode(result.get_field("features").numpy()).decode('utf-8')
                })   
